...
- With IOp control (see [https://gaussian.com/dft/](https://gaussian.com/dft/)[^1] and [https://gaussian.com/overlay3/](https://gaussian.com/overlay3/)[^2]), one can _construct_ using `BLYP/basis  IOp(3/76=1000002000) IOp(3/77=0720008000) IOp(3/78=0810010000)`
