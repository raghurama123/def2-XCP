...
or
```
#P BLYP/basisset IOp(3/76=1000002000) IOp(3/77=0720008000) SCF(maxcycles=100)  Int(Grid=ultrafine)
```
...
or
```
/basisset IOp(3/74=419) IOp(3/76=1000010000) IOp(3/77=1000010000) IOp(3/107=0330000000,3/108=0330000000) IOp(3/119=0460000000) IOp(3/120=0460000000) IOp(3/130=01900) IOp(3/131=01900)
```
